...
pipe2 = StableDiffusionPipeline.from_pretrained(model_id2, torch_dtype=torch.float16, safety_checker=None)
#pipe2 = pipe2.to("cuda")
...
get_music(prompt, musicAI_indx=0, duration=4)
